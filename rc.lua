...
local mymainmenu = awful.menu({
  items = { { 'awesome', myawesomemenu, beautiful.awesome_icon }, { 'open terminal', terminal }, { 'firefox', 'firefox' }, { 'files', 'thunar' } },
})
...
local globalkeys = gears.table.join(
  ...
  awful.key({ modkey, 'Shift' }, 'Escape', function() advanced_tag_controls.move_client_to_previous_tags(client) end, { description = 'Move focused client to previous active tag(s)', group = 'tag (advanced)' }),
