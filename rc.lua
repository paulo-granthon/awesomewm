...
-- waits for killall before starting polybar to prevent multiple polybar processes from running when restarting the window manager
awful.spawn.easy_async_with_shell("killall polybar", function()
