...
THEME.taglist_squares_sel = theme_assets.taglist_squares_sel(THEME.taglist_square_size, THEME.base.colors.off_white)
THEME.taglist_squares_unsel = theme_assets.taglist_squares_unsel(THEME.taglist_square_size, THEME.base.colors.off_white)
